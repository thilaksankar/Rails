...
ActiveRecord::Schema.define(version: 2021_03_17_081244) do
  ...
  create_table "post_users_read_status", force: :cascade do |t|
    t.integer "post_id", null: false
    t.integer "user_id", null: false
    t.index ["post_id"], name: "index_post_users_read_status_on_post_id"
    t.index ["user_id"], name: "index_post_users_read_status_on_user_id"
  end
  ...
  add_foreign_key "post_users_read_status", "posts"
  add_foreign_key "post_users_read_status", "users"
